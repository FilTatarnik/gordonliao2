          ...
          <MDBJumbotron style={{ padding: 0 }} id="about-image">
            ...
            style={{ 
              ...
              <MDBCol className="py-5" id="about-text">
                <p className="mx-5 mb-5"></p><h4>“Promise Holdings was created to help small companies reach their promise or potential, while always living and adding value with trust & integrity. That is our promise”</h4>

          ...
          <MDBJumbotron style={{ padding: 0 }} id="about-image">
            ...
            style={{ 
              ...
              <MDBCol className="py-5">
                <MDBCardTitle className="h2-responsive pt-3 m-5 font-bold"><h2>“Promise Holdings was created to help small companies reach their promise or potential, while always living and adding value with trust & integrity. That is our promise”</h2></MDBCardTitle>
